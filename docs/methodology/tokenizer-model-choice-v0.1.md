...
**Status:** Decision rules defined; TM1 is CONFIRMED — OpenAI GPT-4.1-mini/GPT-4.1 family — in `docs/benchmark/v0.1/tm1-tokenizer-model-decision.md` (tm1-v0.1.1, confirmed 2026-06-13; see §12)
...
|---|---|---|---|
| TM1 | Which provider/model will v0.1 use? | CONFIRMED — see `docs/benchmark/v0.1/tm1-tokenizer-model-decision.md` (tm1-v0.1.1) | OpenAI GPT-4.1-mini/GPT-4.1 family (one family, one tokenizer) for all of v0.1; confirmed 2026-06-13; Stage 1a unblocked; v0.1 will not compare multiple tokenizers or families |
