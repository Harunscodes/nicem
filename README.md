...
docs/
  ...
  benchmark/
    v0.1/
      ...
      stage2-model-pricing-config.md — Model IDs, pricing formula, hand-calc, change rules (PENDING confirmation)
...
scripts/
  ...
  stage2_smoke_runner.py      — Stage 2 logging runner skeleton (dry-run default; no API calls)
